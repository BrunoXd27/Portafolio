...
<body>
    ...
    <main id="main" class="admin-page" data-aos="fade" data-aos-delay="1500" >
        ...
        <section id="gallery" class="gallery">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-1.jpg" title="Gallery 1" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-2.jpg" title="Gallery 2" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-3.jpg" title="Gallery 3" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-4.jpg" title="Gallery 4" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
            ...
            <div class="category-edit"><h2 id="design">Dise&ntilde;o de personaje</h2>
                <form action="forms/edit-description.php" method="post" role="form" class="php-edit-form" enctype="multipart/form-data">
                    <input type="file" name="imagen" accept="image/*">
                    <input type="submit" value="Subir">
                </form>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-5.jpg" title="Gallery 5" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-6.jpg" title="Gallery 6" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-7.jpg" title="Gallery 7" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="gallery-item h-100">
                            ...
                            <div class="gallery-links d-flex align-items-center justify-content-center">
                                ...
                                <a href="assets/img/gallery/gallery-8.jpg" title="Gallery 8" class="glightbox preview-link"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div><!-- End Gallery Item -->
            ...
            <div class="category-edit"><h2 id="edition">Edici&oacute;n de video</h2>
                <form action="forms/edit-description.php" method="post" role="form" class="php-edit-form" enctype="multipart/form-data">
                    <input type="file" name="imagen" accept="image/*">
                    <input type="submit" value="Subir">
                </form>
            ...
            <div class="category-edit"><h2 id="animation">Animaci&oacute;n</h2>
                <form action="forms/edit-description.php" method="post" role="form" class="php-edit-form" enctype="multipart/form-data">
                    <input type="file" name="imagen" accept="image/*">
                    <input type="submit" value="Subir">
                </form>
            ...
            <div class="d-flex justify-content-center mt-4">
                <div class="col-lg-6 row">
                  <ul class="description-edit">
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Estudios:</strong> <span>Licenciatura en dise&ntilde;o multimedia y arte digital</span>
                      <div class="form-group">
                        <input type="text" class="form-control" name="studies" id="studies" placeholder="Licenciatura en dise&ntilde;o multimedia y arte digital" required>
                      </div>    
                    </li>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <strong>Descripci&oacute;n:</strong>
                      <div class="form-group">
                        <textarea class="form-control" name="message" rows="10" placeholder="Officiis eligendi itaque labore et dolorum mollitia officiis optio vero. Quisquam sunt adipisci omnis et ut. Nulla accusantium dolor incidunt officia tempore. Et eius omnis.
