...
if (file_exists('..\assets\img\editVideo' . '\\' . $_FILES["video2"]["name"])) {
    ...
    if (isset($_FILES["video2"]) && $_FILES["video2"]["error"] == 0) {
        ...
        $dir2 = 'assets\img\editVideo' . '\\' . $_FILES["video2"]["name"];
        ...
        $sql = "INSERT INTO `video` (`idVideo`, `refVideo`, `idCategoria`) VALUES ('NULL', '$dir2', '103')";
